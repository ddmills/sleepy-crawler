extends Node2D
class_name CharacterAppearance, "res://ui/icons/flat/pen.png"
...
func _on_gender_changed(value):
	sprites.legs_sprite.texture = character.attributes.race.get_legs_texture(value)
	sprites.body_sprite.texture = character.attributes.race.get_body_texture(value)
